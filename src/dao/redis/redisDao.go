...
func (r *RedisDao) Exists(key string) (bool, error) {
	return redis.Bool(r.conn.Do("EXISTS", key))
}

// Expire set a timeout on key
func (r *RedisDao) Expire(key string, ttl int) error {
...
func (r *RedisDao) SetEx(key string, ttl int, value interface{}) error {
...
func (r *RedisDao) Del(key interface{}) (err error) {
	switch key.(type) {
	case []string:
...
func (r *RedisDao) MGet(key []string) ([]string, error) {
	var result []string
...
func (r *RedisDao) HSet(key string, field string, value interface{}) error {
	_, err := r.conn.Do("HSET", key, field, value)
	return err
}

// HGet gets value of a specific field of key
func (r *RedisDao) HGet(key string, field string) (string, error) {
	return redis.String(r.conn.Do("HGET", key, field))
}

// HDel Removes the specified fields from the hash stored at key
func (r *RedisDao) HDel(key string, fieldValue interface{}) (err error) {
...
func (r *RedisDao) HMSet(key string, fieldValue interface{}) error {
	_, err := r.conn.Do("HMSET", redis.Args{}.Add(key).AddFlat(fieldValue)...)
	return err
}

//HMGet returns the values associated with the specified fields in the hash stored at key.
func (r *RedisDao) HMGet(key string, fields interface{}) ([]string, error) {
	var result []string
...
func (r *RedisDao) HGetAll(key string) (map[string]string, error) {
...
func (r *RedisDao) SAdd(key string, member interface{}) (err error) {
	switch member.(type) {
	case []string, []int, []int32, []int64, []float32, []float64, []interface{}:
...
// param 'member' support array of string, int, int32, int64, float32, float64, interface{}
func (r *RedisDao) SRem(key string, member interface{}) (err error) {
	switch member.(type) {
	case []string, []int, []int32, []int64, []float32, []float64, []interface{}:
...
func (r *RedisDao) SIsMember(key string, member interface{}) (bool, error) {
...
func (r *RedisDao) SMembers(key string) ([]string, error) {
	var result []string
